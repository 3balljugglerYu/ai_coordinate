-- ===============================================
-- デイリー投稿特典付与関数
-- 注意: デイリー投稿特典の金額（30ペルコイン）は constants/index.ts の DAILY_POST_BONUS_AMOUNT と一致させる必要があります
-- 注意: この関数は 20260109122329_update_daily_post_bonus_amount_to_30.sql で30ペルコインに更新されました
-- ===============================================
