...
export const enMessages = {
  ...
  posts: {
    ...
    sourcePromptUsageCount: "Used {count} times so far",
    ...
    feedQuoteDerivedTitle: "Generated with this prompt",
    feedQuoteStyleTitle: "Generated with this style",
    readMore: "Read more",
    collapse: "Show less",
    errorTitle: "Error",
  ...
  challenge: {
    ...
    dailyOneTapLabel: "Post with One-Tap Style",
    dailyFreeLabel: "Post with Free Style",
    dailyPromptUseLabel: "Post a creation from someone's prompt",
    dailyPromptUseHint: "Using someone's prompt earns {amount} Percoins together with the free post bonus",
