...
export const enMessages = {
  ...
  posts: {
    ...
    promptVisibilityLabel: "Show the prompt",
    promptVisibilityHint: "Turn this off to keep the prompt hidden from everyone. Followers can still generate with it without seeing it.",
