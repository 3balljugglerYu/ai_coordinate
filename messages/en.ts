...
export const enMessages = {
  ...
  posts: {
    ...
    completionViewBook: "📖 Flip through",
    completionViewMount: "✨ View the card",
    ...
    sourcePromptCopy: "Copy the prompt",
    sourcePromptCopied: "Copied",
    sourcePromptCopyFailed: "Could not copy",
    sourcePromptOpenOriginConfirmTitle: "Open the original post?",
    sourcePromptOpenOriginConfirmDescription: "Choosing Yes takes you to the original post for this prompt.",
    sourcePromptOpenOriginConfirmCancel: "Cancel",
    sourcePromptOpenOriginConfirmAction: "Yes",
    ...
    lockedSheetPromptLocked: "This prompt is private",
    lockedSheetClose: "Close",
    hiddenMessage: "This post is hidden based on your display settings.",
    prompt: "Prompt",
    metaModelLabel: "Generation model",
    metaModeLabel: "Generation mode",
    metaSizeLabel: "Size",
    ...
    homeViewSwitchNoticeTitle: "A new look for your feed",
    homeViewSwitchNoticeBody: "Posts now appear larger. You can switch back to the previous layout here anytime.",
    homeViewSwitchNoticeConfirm: "OK",
    feedExpandImage: "Expand image",
    feedComments: "Comments",
    feedUsePrompt: "Generate with this prompt",
    feedFollowAndUsePrompt: "Follow to generate",
    feedQuotePromptCreator: "Prompt creator",
    ...
    postBonusTitle: "Mission complete!",
    ...
    postBonusPromptUseLink: "About using prompts",
    postBonusClose: "OK",
    ...
    replyToChip: "Replying to @{name}",
    replyToClear: "Clear reply target",
    replyQuoteDeleted: "Deleted comment",
    replySheetTitle: "Add a reply",
    replySubmit: "Reply",
    replySubmitting: "Replying...",
    replyCreateFailed: "Failed to post the reply.",
    replyToInvalid: "Invalid reply target",
  ...
  myPage: {
    ...
    bulkDeleteStart: "Bulk delete",
    bulkDeleteCancel: "Cancel",
    bulkDeleteUnpostedOnlyNote: "Only unposted images can be deleted.",
    bulkDeleteSelectedCount: "{count} selected",
    bulkDeleteActionWithCount: "Delete ({count})",
    bulkDeleteEmptyAction: "Delete",
    bulkDeleteConfirmTitle: "Delete the selected images?",
    bulkDeleteConfirmDescription:
      "{count} images will be permanently deleted. This action cannot be undone.",
    bulkDeleteConfirmAction: "Delete",
    bulkDeleteInProgress: "Deleting...",
    bulkDeleteSuccessTitle: "Deletion complete",
    bulkDeleteSuccessDescription: "Deleted {count} images.",
    bulkDeletePartialFailureTitle: "Some images could not be deleted",
    bulkDeletePartialFailureDescription: "{count} failed.",
    bulkDeleteFailureTitle: "Deletion failed",
    bulkDeleteFailureDescription: "Please try again.",
    bulkDeleteSelectImageAria: "Select image",
    ...
    inspireResubmitAction: "Re-submit",
    inspireDeleteAction: "Delete",
    inspireDeleteConfirmTitle: "Delete this template?",
    inspireDeleteConfirmDescription:
      "This submission history and related images (template + previews) will be permanently deleted.",
  ...
  inspireSubmission: {
    ...
    step2Title: "Step 2 / 3 — Try on simulation",
    step2Description:
      "We'll dress this character in your template style and generate previews with two AI models in parallel. Please wait ~60–90 seconds.",
    step2YourTemplateLabel: "Your template",
    ...
    step2NextButton: "Try on this character",
    step3Title: "Step 3 / 3 — Compare results",
    step3Description:
      "Compare your original template with the generated results. Submit when ready.",
    step3TemplateLabel: "Your template (original)",
    step3PreviewLabel: "OpenAI result",
    step3PreviewLabelGemini: "Gemini result",
    step3PreviewMissing: "(this model failed to generate)",
    stepIndicatorLabel: "Step {current} / {total}",
    step3ConsentLabel:
    ...
    closeConfirmTitle: "Cancel this submission?",
    closeConfirmDescription:
      "Any entered content and generated previews will be discarded.",
    closeConfirmAction: "Cancel submission",
    closeConfirmCancel: "Keep editing",
    enlargeImageAriaLabel: "Click to enlarge",
    enlargedImageClose: "Close",
    enlargedPrev: "Previous image",
    enlargedNext: "Next image",
    // Creator Looks specific (shown only when isCreatorLooksMode=true)
  ...
  credits: {
    ...
    transactionTypeCollectionCompletion: "Collection completion reward",
    transactionTypePromptUseBonus: "Prompt use bonus",
    transactionTypePromptUsageReward: "Prompt usage reward",
    transactionTypeStyleUsageReward: "Style usage reward",
  ...
  coordinate: {
    ...
    gptImage2QualityLabel: "Rendering quality",
    ...
    modelNewBadge: "NEW",
    modelSwitchNoticeTitle: "The generation model has been updated",
    modelSwitchNoticeBody: "With ChatGPT Images 2.5, the wait is about half as long.\nYou can switch back to 2.0 here anytime.",
    ...
    gptImage2SizeDescription:
      "The exact dimensions are adjusted automatically to match the image orientation. Percoin cost changes by output size.",
    ...
    gptImage2Size1k: "Standard: up to 1536 px",
    gptImage2Size2k: "High resolution: up to 2496 px",
    ...
    geminiBananaSize05k: "Light: approx. 512 px",
    geminiBananaSize1k: "Standard: approx. 1024 px",
    geminiBananaSize2k: "High resolution: approx. 2048 px",
    geminiBananaSize4k: "Maximum resolution: up to 5504 px",
    // Phase 6: guest UI
    ...
    postAction: "Post",
    promptClear: "Clear",
    galleryViewToggleLabel: "Display mode",
    galleryViewGrid: "Grid",
    galleryViewList: "List",
    listThumbnailAlt: "Generated image thumbnail",
    listGeneratedAt: "Generated at {date}",
    listUsedPromptLabel: "Prompt used",
    listCopyPrompt: "Copy",
  ...
  challenge: {
    ...
    goalCompleteHeadline: "2-week streak complete!",
    ...
    dailyPendingDescription: "Share one generated image to earn +{amount} coins.",
    resetIn: "Resets in",
    tipsLabel: "Tip:",
  ...
  free: {
    ...
    aspectSectionTitle: "Aspect ratio",
    aspectAuto: "Auto",
    aspectAutoDescription: "Match the uploaded image",
    aspectSquare: "Square",
  ...
  style: {
    ...
    styleChipAllNewest: "All (Newest)",
    // /styles の生成シートの読み上げ用タイトル・説明(画面には出さない)
    generationSheetTitle: "Generate with this style",
    generationSheetDescription: "Generate from your character image with the selected style.",
    ...
    presetLockedLabel: "Not unlocked yet",
    presetLockedTitle: "This style isn't unlocked yet",
    presetLockedSequentialDescription: "Generate with styles from this collection to unlock the next one.",
    presetLockedPrerequisiteDescription: "Complete the previous collection to unlock this.",
    presetLockedAction: "Got it",
    presetLoginRequiredLabel: "Available after signing in",
    presetLoginRequiredTitle: "Sign in to use this style",
    presetLoginRequiredDescription: "Sign in and generate with this collection to unlock the rest, one by one.",
    presetLoginRequiredAction: "Sign in / Sign up",
    ...
    invalidOutputAspectRatio: "The selected aspect ratio is invalid.",
    aspectSectionTitle: "Aspect ratio",
    aspectAuto: "Auto",
    aspectAutoDescription: "Match the uploaded image",
    aspectPresetImage: "Same as sample",
    aspectPresetImageDescription: "Match the style sample's ratio",
    aspectSquare: "Square",
    aspectPortrait: "Portrait",
    aspectLandscape: "Landscape",
    ...
    tourButton: "Tutorial",
    tourButtonAriaLabel: "Start the One-Tap Style tutorial",
    tourPrevButton: "Back",
    tourNextButton: "Next",
  ...
  notifications: {
    ...
    usageMilestoneFirstTitle: "Your prompt “{origin}” was used for the first time",
    usageMilestoneFirstTitleNoCaption: "Your prompt was used for the first time",
    usageMilestoneTitle: "Your prompt “{origin}” has been used {count} times",
    usageMilestoneTitleNoCaption: "Your prompt has been used {count} times",
  ...
  home: {
    ...
    eventShelfCountdownHoursMinutesSeconds: "{hours}h {minutes}m {seconds}s left",
    eventShelfCountdownMinutesSeconds: "{minutes}m {seconds}s left",
    eventShelfCountdownSeconds: "{seconds}s left",
  ...
  adminStyleTemplates: {
    ...
    pageDescription: "Review and manage user-submitted style templates.",
    tabPending: "Pending",
    tabActive: "Active",
    tabRemoved: "Removed / Withdrawn",
    submittedAt: "Submitted at",
    submitterId: "Submitter ID",
    submitterLabel: "Submitter",
    submitterAnonymous: "Anonymous user",
    submitterViewProfile: "Open user details",
    ...
    reasonPlaceholder: "(optional) Reason shown to submitter",
    confirmTitle: "Are you sure?",
    confirmAction: "Confirm",
    confirmCancel: "Cancel",
    decisionSuccess: "Updated.",
    decisionFailed: "Failed to update.",
    orderUpdateSuccess: "Order updated.",
    orderUpdateFailed: "Failed to update order.",
    moveUp: "Move up",
    moveDown: "Move down",
    emptyPending: "No pending templates.",
    emptyActive: "No active templates.",
    emptyRemoved: "No removed/withdrawn templates.",
    detailLabel: "Details",
    detailClose: "Close",
