export const jaMessages = {
  ...
  posts: {
    ...
    postBonusPromptUseLink: "プロンプトの利用について",
    postBonusClose: "OK",
  ...
  coordinate: {
    ...
    modelNewBadge: "NEW",
    modelSwitchNoticeTitle: "生成モデルが新しくなりました",
    modelSwitchNoticeBody: "ChatGPT Images 2.5 で、待ち時間が約半分になりました。\nこれまでの 2.0 に戻したいときは、ここから切り替えられます。",
