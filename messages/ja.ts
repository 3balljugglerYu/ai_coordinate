export const jaMessages = {
  ...
  posts: {
    ...
    noImage: "画像がありません",
    postImageAlt: "投稿画像",
    completionBadge: "コンプリート",
    completionViewBook: "📖 めくって見る",
    completionViewMount: "✨ カードを見る",
    ...
    sourcePromptUsageCount: "これまでに{count}回使われました",
    ...
    sourcePromptOpenOriginConfirmDescription: "「はい」を選択すると、このプロンプトの原作の投稿へ移動します。",
    ...
    lockedSheetPromptLabel: "プロンプト",
    lockedSheetPromptLocked: "プロンプトは非公開です",
    lockedSheetClose: "閉じる",
    ...
    shareFailed: "共有に失敗しました",
      suspendedDialogTitle: "このコンテンツは公開停止中です",
  ...
  myPage: {
    ...
    bulkDeleteStart: "一括削除",
    bulkDeleteCancel: "キャンセル",
    bulkDeleteUnpostedOnlyNote: "未投稿の画像のみ削除できます",
    bulkDeleteSelectedCount: "{count} 件選択中",
    bulkDeleteActionWithCount: "削除（{count}）",
    bulkDeleteEmptyAction: "削除",
    bulkDeleteConfirmTitle: "本当に削除しますか？",
    bulkDeleteConfirmDescription:
      "選択した {count} 件の画像を完全に削除します。この操作は取り消せません。",
    bulkDeleteConfirmAction: "削除する",
    bulkDeleteInProgress: "削除中...",
    bulkDeleteSuccessTitle: "削除が完了しました",
    bulkDeleteSuccessDescription: "{count} 件削除しました",
    bulkDeletePartialFailureTitle: "一部の画像を削除できませんでした",
    bulkDeletePartialFailureDescription: "{count} 件失敗しました",
    bulkDeleteFailureTitle: "削除に失敗しました",
    bulkDeleteFailureDescription: "もう一度お試しください",
    bulkDeleteSelectImageAria: "画像を選択",
    ...
    inspireResubmitAction: "再申請",
    inspireDeleteAction: "削除",
    inspireDeleteConfirmTitle: "このテンプレートを削除しますか?",
    inspireDeleteConfirmDescription:
      "この申請履歴と関連画像（テンプレート・プレビュー）は完全に削除されます。",
    ...
    inspireOpenForGenerationAria: "このテンプレートで生成画面を開く",
      moderationSuspendedBadge: "公開停止",
    moderationThumbnailHidden: "内容の性質上、画像は表示していません",
  },
  inspireSubmission: {
    ...
    step2Title: "Step 2 / 3 — 試着シミュレーション",
    step2Description:
      "このキャラクターに、あなたのテンプレ画像のスタイルを着せたらどう見えるか、2 つの AI で同時に生成します。約 60〜90 秒お待ちください。",
    step2YourTemplateLabel: "あなたのテンプレ",
    ...
    step2NextButton: "このキャラクターで試着します",
    step3Title: "Step 3 / 3 — 結果を比較",
    step3Description:
      "あなたのテンプレと、別のキャラクターに適用した結果を見比べてください。問題なければ「申請する」を押すと運営審査に進みます。",
    step3TemplateLabel: "あなたのテンプレ（元画像）",
    step3PreviewLabel: "OpenAI 生成結果",
    step3PreviewLabelGemini: "Gemini 生成結果",
    ...
    closeConfirmTitle: "申請を取り消しますか？",
    closeConfirmDescription:
      "入力中の内容と生成済みのプレビューは破棄されます。",
    closeConfirmAction: "取り消す",
    closeConfirmCancel: "続ける",
    enlargeImageAriaLabel: "クリックして拡大表示",
  ...
  moderation: {
    ...
    decisionPageTitle: "投稿の措置について",
    decisionPageDescription: "実施された措置とその理由、異議申立ての経過を確認できます。",
    actionLabel: "措置",
    actionSuspended: "公開停止",
    actionSuspendedDetail: "すべての利用者に非表示",
    scopeLabel: "範囲",
    scopeAllUsers: "全世界のすべての利用者",
    durationLabel: "期間",
    durationUntilReversed: "解除されるまで（期限の定めなし）",
    decidedAtLabel: "判定日時",
    notDeletedNotice: "画像そのものは削除されていません。マイページの生成一覧には残っています。",
    policyLabel: "違反したポリシー",
    policyVersionLabel: "適用した版",
    guidelinesLink: "コミュニティガイドラインの該当条項を読む",
    reasonLabel: "運営からの説明",
    reasonUnavailable: "説明は記録されていません。",
    automatedLabel: "自動判定の関与",
    automatedYes: "自動的な手段を使用しました",
    automatedNo: "自動的な手段は使用していません",
    targetPostLabel: "対象の投稿",
    thumbnailHidden: "内容の性質上、画像は表示していません",
    thumbnailUnavailable: "画像を表示できません",
    appealSection: "異議申立て",
    appealDeadlineNotice: "申立ての期限は {deadline} です。",
    appealDeadlineNotYetStarted: "通知の配信が完了するまで、申立ての期限は開始しません。",
    appealStatusPending: "審査中",
    appealStatusOverturned: "認容（公開を再開しました）",
    appealStatusUpheld: "棄却（公開停止を維持します）",
    appealSubmittedAt: "申立て日時",
    appealYourMessage: "申立ての内容",
    appealResultReason: "審査結果の理由",
    appealDecidedAt: "審査日時",
    appealClosed: "この判定に対する異議申立ての受付は終了しています。",
    appealNotNeeded: "この投稿は現在公開されています。異議申立ての必要はありません。",
    contactNotice: "ご不明な点は、お問い合わせ窓口からご連絡ください。",
    appealBodyLabel: "申立ての理由",
    appealBodyPlaceholder: "判定に納得できない理由や、審査時に考慮してほしい情報をご記入ください。",
    appealSubmit: "異議を申し立てる",
    appealSubmitting: "送信中…",
    appealSubmittedTitle: "異議申立てを受け付けました",
    appealSubmittedDescription: "内容を確認し、結果を通知します。",
    appealSubmitFailedTitle: "異議申立ての送信に失敗しました",
    appealSubmitFailed: "しばらくしてから再試行してください。",
      statusRestoredByAppeal: "異議申立てが認められ、この投稿は公開に戻りました。",
    statusCurrentlySuspended: "この投稿は現在、公開を停止しています。",
    statusSupersededSuspension: "この措置は解除されています。ただし、その後の別の判定により現在は公開を停止しています。",
    statusCurrentlyPublished: "この投稿は現在、公開されています。",
  },
  credits: {
    ...
    transactionTypePromptUseBonus: "プロンプト利用ボーナス",
  ...
  coordinate: {
    ...
    stockLimitReachedInline: "上限に達しています。",
    ...
    postAction: "投稿",
    promptClear: "クリア",
    galleryViewToggleLabel: "表示モード",
    galleryViewGrid: "グリッド",
    galleryViewList: "リスト",
    listThumbnailAlt: "生成画像のサムネイル",
    listGeneratedAt: "生成日時 {date}",
    listUsedPromptLabel: "使用プロンプト",
    listCopyPrompt: "コピー",
  ...
  challenge: {
    ...
    checkIn: "チェックイン",
    rewardCoinsLabel: "+{amount} ペルコイン獲得！",
    goalCompleteHeadline: "2週間コンプリート！",
    ...
    dailyOneTapLabel: "ワンタップスタイルで投稿",
    dailyFreeLabel: "フリースタイルで投稿",
    dailyPromptUseLabel: "他の人のプロンプトで作って投稿",
    dailyPromptUseHint: "他の人のプロンプトを使うと、フリー投稿と合わせて {amount} ペルコインもらえます",
  ...
  style: {
    ...
    presetLockedPrerequisiteDescription: "前の企画を完走すると開放されます。",
    presetLockedAction: "わかりました",
    presetLoginRequiredLabel: "ログインすると使えます",
    presetLoginRequiredTitle: "このスタイルはログインすると使えます",
    presetLoginRequiredDescription: "ログインしてこの企画のスタイルを生成すると、続きのスタイルが順に開放されます。",
    presetLoginRequiredAction: "ログイン / 新規登録",
    ...
    invalidOutputAspectRatio: "出力比率の指定が無効です。",
    aspectSectionTitle: "画像の比率",
    aspectAuto: "自動",
    aspectAutoDescription: "アップロード画像に合わせる",
    aspectPresetImage: "見本と同じ",
    aspectPresetImageDescription: "スタイル見本の比率に合わせる",
    aspectSquare: "正方形",
    aspectPortrait: "縦長",
    aspectLandscape: "横長",
    ...
    tourButton: "チュートリアル",
    tourButtonAriaLabel: "One-Tap Style の使い方チュートリアルを開始",
    tourPrevButton: "もどる",
    tourNextButton: "つぎへ",
  ...
  notifications: {
    ...
    usageMilestoneFirstTitle: "あなたの「{origin}」のプロンプトが初めて利用されました",
    usageMilestoneFirstTitleNoCaption: "あなたのプロンプトが初めて利用されました",
    usageMilestoneTitle: "あなたの「{origin}」のプロンプトが{count}回利用されました",
    usageMilestoneTitleNoCaption: "あなたのプロンプトが{count}回利用されました",
    ...
    hoursAgo: "{count}時間前",
    daysAgo: "{count}日前",
      moderationRemovedTitle: "投稿を公開停止しました",
    moderationRemovedBody: "コミュニティガイドラインに基づき、この投稿の公開を停止しました。",
    moderationAppealUpheldTitle: "異議申立ての審査結果をお知らせします",
    moderationAppealOverturnedTitle: "異議申立てが認められました",
    moderationAppealResultTitle: "異議申立ての審査結果をお知らせします",
  },
  home: {
    heading: "Persta | ペルスタ",
    subtitle: "着てみたいも、なりたいも。AIスタイリングプラットフォーム",
    stylePresetCarouselTitle: "簡単お着替え！",
    stylePresetCarouselCaption: "新着と人気のスタイルを表示中",
    ...
    eventShelfCountdownHoursMinutesSeconds: "あと{hours}時間{minutes}分{seconds}秒",
    eventShelfCountdownMinutesSeconds: "あと{minutes}分{seconds}秒",
    eventShelfCountdownSeconds: "あと{seconds}秒",
  ...
  adminStyleTemplates: {
    ...
    pageDescription: "ユーザー投稿のスタイルテンプレートを審査・管理する。",
    tabPending: "審査待ち",
    tabActive: "公開中",
    tabRemoved: "差戻し / 取り下げ",
    submittedAt: "申請日時",
    submitterId: "申請者 ID",
    submitterLabel: "申請者",
    submitterAnonymous: "匿名ユーザー",
    submitterViewProfile: "ユーザー詳細を開く",
    moderationReason: "理由",
    actionApprove: "承認",
    actionReject: "差戻し",
    actionUnpublish: "非公開化",
    actionApproved: "承認済み",
    actionRejected: "差戻し済み",
    reasonPlaceholder: "（任意）申請者に通知される理由を入力",
    confirmTitle: "本当に実行しますか?",
    confirmAction: "実行",
    confirmCancel: "キャンセル",
    decisionSuccess: "操作を反映しました。",
    decisionFailed: "操作に失敗しました。",
    orderUpdateSuccess: "並び順を更新しました。",
    orderUpdateFailed: "並び順の更新に失敗しました。",
    moveUp: "上へ",
    moveDown: "下へ",
    emptyPending: "審査待ちのテンプレートはありません。",
    emptyActive: "公開中のテンプレートはありません。",
    emptyRemoved: "差戻し / 取り下げ済みのテンプレートはありません。",
    detailLabel: "詳細",
    detailClose: "閉じる",
  ...
  inspirePage: {
    ...
    submitterAnonymous: "匿名ユーザー",
    submitterViewProfile: "ユーザーのプロフィールを開く",
    selectedTemplateLabel: "選択中のスタイル",
    formGenerateAria: "選択中のスタイルで生成する",
  ...
  imageSourcePicker: {
    triggerLabel: "生成済み/ストックから選ぶ",
    triggerHint: "過去の生成画像や保存済みの素材から選択",
    sheetTitle: "画像を選ぶ",
    sheetClose: "閉じる",
    tabGenerated: "生成済み",
    tabStock: "ストック",
    stockCountStatus: "保存中 {current} / {limit} 枚",
    stockCountStatusLimitReached: "保存中 {current} / {limit} 枚（上限）",
    stockAddTileLabel: "追加",
    stockAddTileAria: "ストック画像を追加",
    stockDeleteAria: "このストック画像を削除",
    stockDeleteConfirm: "このストック画像を削除しますか?",
    selectImageAria: "この画像を選ぶ",
    emptyGeneratedTitle: "まだ生成画像がありません",
    emptyGeneratedDescription:
      "スタイルやコーディネートを生成すると、ここに表示されます。",
    emptyStockTitle: "ストック画像がありません",
    emptyStockDescription:
      "ストック画像を追加すると、ここに表示されます。",
