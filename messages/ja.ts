export const jaMessages = {
  ...
  coordinate: {
    ...
    modelLabel: "生成モデルを選択",
    modelTooltipAria: "生成モデルの違いを表示",
    modelTooltipContent: "💡 Highにするほど顔や服の細部が崩れにくく仕上がります。\nLow：速く生成します。約30秒程度で生成。\nMedium：バランス重視。約70秒程度で生成。\nHigh：細部が崩れにくい。約180秒程度で生成。",
    gptImage2QualityLabel: "生成タイプを選択",
    gptImage2QualityLow: "素早く生成",
    gptImage2QualityMedium: "バランスよく生成",
    gptImage2QualityHigh: "丁寧に生成",
    ...
    geminiBananaSizeDescription: "解像度が大きいほど消費ペルコインが増えます。",
