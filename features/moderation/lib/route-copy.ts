...
export const moderationRouteCopy = {
  ja: {
    ...
    appealNotFound: "対象の判定が見つかりません",
    appealAlreadyExists: "この判定には既に異議を申し立てています",
    appealDeadlinePassed: "異議申立ての期限を過ぎています",
    appealNotApplicable: "この投稿は現在公開停止されていないため、異議申立ての対象外です",
    appealCreateFailed: "異議申立ての登録に失敗しました",
  },
  en: {
    ...
    appealNotFound: "The moderation decision was not found.",
    appealAlreadyExists: "You have already appealed this decision.",
    appealDeadlinePassed: "The appeal window has closed.",
    appealNotApplicable: "This post is not currently restricted, so it cannot be appealed.",
    appealCreateFailed: "Failed to submit the appeal.",
  },
  ko: {
    authRequired: "You need to be logged in.",
    invalidRequest: "The request is invalid.",
