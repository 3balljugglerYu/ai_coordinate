...
export function CollabRecruitGuide({
  ...
  const benefits: { title: string; body: string; icon: ReactNode }[] = [
    ...
    },
    {
      ...
      body: "企画ページ・One-Tap Style の各カードに、アイコン、お名前、Xリンクを掲載します。さらに参加者へのリポストにもお名前とXリンクが載り続けるので、企画を楽しんだ方があなたのもとへ届きます。",
      icon: (
    ...
    {
      title: "毎日の運用は、運営と一緒に",
      body: "開催中の告知・ポスト文の作成・参加者への返信やリポスト・スケジュール管理は、運営が中心となって担当します。「毎日投稿を考えるのが大変そう」という心配はいりません。",
      icon: (
  ...
  const steps: {
  ...
  }[] = [
    {
      no: "01",
      title: "相談する",
      body: "X(DM)から「コラボしてみたい / 話を聞きたい」とご連絡ください。イラストやプロンプト、SNSを見せていただけるとスムーズです。",
    ...
    },
    {
      ...
      roles: [
        { label: "あなた", text: "イラスト・プロンプトの共有、運営とSNS告知を実施" },
  ...
  const faqs: { q: string; a: string[] }[] = [
    ...
    },
    {
      q: "どんな方がコラボに向いていますか？",
      a: [
        "Xでの投稿内容や世界観、ペルスタとの相性、シリーズ（コレクション）として広げていけそうかなどを拝見したうえで、一緒に進め方を考えさせていただきます。",
        "フォロワー数や実績だけで決めることはないので、まずはお気軽にご相談ください。",
      ],
    },
    {
      q: "報酬はありますか？",
