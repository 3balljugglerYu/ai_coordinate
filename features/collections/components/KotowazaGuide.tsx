...
export function KotowazaGuide({
  ...
  const steps: {
    ...
    },
    {
      ...
      b: `${threshold}種類そろえると、${threshold}枚を飾れる限定コンプリートカードが完成！（コンプリートで 20 ペルコインのプチボーナスも）`,
    },
    {
      n: "04",
      t: "コンプリートで【下巻】解放！",
      b: `【上巻】の${threshold}語をそろえると、あたらしい${threshold}語の【下巻】が出現。下巻もそろえて、全${threshold * 2}語の辞典を完成させよう！（下巻コンプリートで 40 ペルコイン）`,
    },
    {
      n: "05",
      t: "ダウンロード＆シェア",
