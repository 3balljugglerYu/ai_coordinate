...
const AdminLoginMethodMixChart = dynamic(
  () => import("./AdminLoginMethodMixChart"),
  {
    ssr: false,
    loading: () => (
...
interface AdminLoginMethodMixChartPanelProps {
  data: DashboardLoginMethodMixItem[];
}

export function AdminLoginMethodMixChartPanel({
  data,
}: AdminLoginMethodMixChartPanelProps) {
  return <AdminLoginMethodMixChart data={data} />;
}
