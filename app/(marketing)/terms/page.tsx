          ...
          sections: [
            ...
            },
            {
              ...
              list: [
                ...
                "異議申立て：投稿の公開停止措置を受けたユーザーは、措置の通知から原則として14日以内に異議を申し立てることができます。申立ては、公開停止の通知から遷移する判定内容の画面で行えます。同画面では、実施された措置・範囲・期間、違反したポリシー、運営からの説明を確認できます。当サービスは合理的な期間内に再審査を行い、認容・棄却のいずれの場合も理由を添えて結果を通知します。認容した場合は投稿の公開を再開します。通報者が誰であるかは、いかなる場合も投稿者に開示しません。CSAM 等明白かつ重大な違反については、異議申立てを認めない場合があります。",
