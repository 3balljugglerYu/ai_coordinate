  ...
  const copy =
    locale === "ja"
      ? {
          title: "コミュニティガイドライン",
          description:
            "Persta.AI（以下「当サービス」）を、すべてのユーザーが安心して利用できる場とするため、本ガイドラインを定めます。本ガイドラインは利用規約の一部を構成するものであり、違反した場合は段階的執行措置の対象となります。",
          sections: [
            {
              icon: "scroll",
              title: "1. 基本理念",
            ...
            },
            {
              icon: "shield",
              title: "3. 一般的な禁止事項",
              description: "段階的執行の対象となる主な違反",
              paragraphs: [
                "以下の行為は、違反の重大性・反復性に応じて、警告、コンテンツ非公開・削除、機能制限、一時停止、永久停止等の措置の対象となります。",
              ],
              list: [
            ...
            },
            {
              ...
              paragraphs: [
                ...
                "生成 AI モデルの安全フィルタが特定の状況で緩和される設定となっている場合がありますが、緩和されているからといって本ガイドラインで禁止しているコンテンツの生成・投稿が許容されるわけではありません。生成結果の最終的な責任はユーザーが負います。",
            ...
            },
            {
              ...
              paragraphs: [
                ...
                "特に、特定のキャラクター、商標、意匠、有名作品のスタイル等を、権利者の許諾なく商業的に利用することはできません。個人的な創作の範囲を超える場合や、対象作品の権利関係に疑義がある場合は、利用を控えるか、権利者の許諾を得てください。",
            ...
            },
            {
              ...
              paragraphs: [
                "当サービスは、違反の重大性、反復性、悪質性、コミュニティへの影響等を勘案し、原則として以下の段階的措置を講じます。重大な違反（CSAM、深刻な権利侵害、明確な犯罪行為、重大な安全リスク等）については、段階を経ずに永久停止等の厳格な措置を講じます。",
              ],
              list: [
                "（1）警告：軽微な違反、初回の違反等。今後の遵守を促します。",
                "（2）コンテンツの非公開・削除：通報の重み付けが一定のしきい値に達した時点で自動的に非公開化し、人手による審査の上で削除等を判断します。",
                "（3）機能制限・一時停止：投稿、コメント、通報等の特定機能を一定期間制限します。一時停止中はログイン・投稿等の主要機能が利用できなくなります。",
                "（4）永久停止：重大または反復した違反が認められた場合、当該アカウントを永久に利用停止します。原則として再登録は認められません。",
                "（5）当局通報・証拠保全：CSAM 等、法令上通報義務または通報の必要があると判断されるコンテンツについては、関係当局への通報および証拠保全を行います。",
              ],
            },
            {
              icon: "heart",
