      ...
      ? {
          ...
          sections: [
            ...
            },
            {
              ...
              list: [
                "コンテンツの公開停止：通報の重み付けが一定のしきい値に達した時点で自動的に非公開化し、人手による審査の上で公開停止等を判断します。公開停止と判断した場合は、違反したポリシーおよび理由をアプリ内通知でお知らせします。公開停止された投稿は投稿前（未投稿）の状態に戻り、他の利用者からは見えなくなりますが、生成画像そのものは削除されず、マイページの生成一覧に残ります。ご自身で内容を確認することもできます。ただし公開停止されたコンテンツは、異議申立てが認められない限り、再度投稿することはできません。",
            ...
            },
            {
              ...
              paragraphs: [
                "投稿の公開停止措置を受けたユーザーは、措置の通知から原則として14日以内に異議を申し立てることができます。申立ては、公開停止の通知をタップして表示される判定内容の画面から行えます。同じ画面では、実施された措置とその期間、違反したポリシーとその版、運営からの説明、自動的な手段を用いたかどうか、審査の経過と結果をあわせて確認できます。公開停止されたコンテンツを再度投稿しようとした場合にも、同じ画面をご案内します。",
                ...
                "なお、CSAM 等、法令違反が明白かつ重大な事案については、異議申立てを受け付けた場合でも、再審査の結果これを認めないことがあります。",
              ],
            },
            {
              icon: "alert",
