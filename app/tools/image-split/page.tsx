...
const PAGE_TITLE = "X用 画像4分割ツール｜縦4分割・2×2対応・無料 | Persta.AI";
const PAGE_DESCRIPTION =
  "横長画像を縦に4分割してXに投稿できる無料ツール。2×2分割にも対応。ブラウザ内で処理するので画像はアップロードされず、登録も不要。スマホからは共有シートでそのままXに投稿できます。";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "X用 画像4分割ツール｜縦4分割・2×2対応",
    description:
      "横長画像を縦4分割してXへ。ブラウザ内処理でアップロード不要・登録不要の無料ツール。",
    type: "website",
    siteName: "Persta.AI",
  },
  twitter: {
      ...
      <div className="mx-auto max-w-3xl px-4 pb-16 pt-8">
        <header className="mb-6 space-y-2">
          ...
          <p className="text-sm leading-6 text-slate-600">
            ...
            タイムラインでは2×2に並び、タップしてスワイプすると
            パノラマのようにつながって見えます。登録不要・無料です。
          </p>
        </header>
        <ImageSplitTool />
      </div>
