...
| Home promotion banners | `popup_banners`, `popup_banner_views`, `popup_banner_analytics` | `record_popup_banner_interaction` | `/api/popup-banners/**`, `/api/admin/popup-banners/**`, `/admin/popup-banners` |
