...
| `style_usage_events` | One-Tap Style usage log recorded via service role with authenticated / guest state; admin aggregation counts visits, generations, downloads, and rate-limit hits |
