...
- `/api/catalog/submissions`: 画像は 10MB まで、同一会員または同一ゲスト token ごとに 1 企画 3 件まで
...
| PATCH | `/api/admin/catalog/campaigns/[id]` | admin session | 絵師カタログ企画を更新する |
| DELETE | `/api/admin/catalog/campaigns/[id]` | admin session | 絵師カタログ企画を削除する |
| GET | `/api/admin/catalog/campaigns` | admin session | 絵師カタログ企画一覧を取得する |
| POST | `/api/admin/catalog/campaigns` | admin session | 絵師カタログ企画を作成する |
| POST | `/api/admin/catalog/entries/[id]/decision` | admin session | カタログ申請の承認・差戻し・非公開化を確定する |
| PATCH | `/api/admin/catalog/entries/[id]/order` | admin session | カタログページの表示順を更新する |
| GET | `/api/admin/catalog/entries` | admin session | カタログ申請一覧を取得する |
...
| Method | Path | Access | Summary |
| --- | --- | --- | --- |
| GET | `/api/catalog/campaigns/[slug]` | public | 公開中のカタログ企画詳細と公開ページ一覧を取得する |
| GET | `/api/catalog/campaigns` | public | 公開中のカタログ企画一覧を取得する |
| GET | `/api/catalog/entries/[id]` | public | 公開中のカタログページ詳細を取得する |
| POST | `/api/catalog/submissions` | public | 絵師カタログへ作品を申請する。Turnstile 検証、画像アップロード、審査待ち登録を行う |
...
| Method | Path | Access | Summary |
| --- | --- | --- | --- |
| GET | `/api/posts/[id]/comments` | public | 指定投稿のトップレベルコメント一覧を取得する |
